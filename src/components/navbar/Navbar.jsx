      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            {/* Mobile menu button*/}
            <DisclosureButton className="group relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-c2 hover:text-light focus:outline-none focus:ring-2 focus:ring-inset focus:ring-lighttext-light">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-between">
            <div className="flex flex-shrink-0 items-center">
              <Link
                to="/home"
                className={`${navCSS.logo} bg-gradient-to-r from-c2 via-c2 to-light text-transparent bg-clip-text text-4xl font-medium tracking-wide`}
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <button
              type="button"
              className="relative rounded-full p-1 text-gray-400 hover:text-light"
            >
              ...
              >
                <MenuItem>
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      classNames(
                        "block px-4 py-2 text-sm text-center text-c2 hover:bg-c1 hover:text-light transition",
                        isActive && "bg-c1 text-light "
                      )
                    }
                  >
                    Your Profile
                ...
                <MenuItem>
                  <button className="block px-4 w-full py-2 text-sm text-c2 hover:bg-c1 hover:text-light transition">
                    Sign out
                  </button>
                </MenuItem>
              </MenuItems>
          ...
          {navigation.map((item) => (
            <DisclosureButton
              ...
              className={classNames(
                item.current
                  ? "bg-c2 text-light"
                  : "text-light hover:bg-c2 hover:text-light",

        ...
        <div className="relative flex h-20 items-center justify-between">
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      classNames(
                        ...
                        "rounded-md px-3 py-2 text-[16px] font-medium cursor-pointer"
                      )
                    }
                  >
                    {item.name}
          ...
          {token ? (
            ...
            <div className=" flex justify-between text-[16px] items-center space-x-2">
              <Link
                to="/login"
                className="rounded-md px-3 py-2 text-sm font-medium button1 hover:light"
              >
                Login
              </Link>
              <Link
                to="/signup"
                className="rounded-md px-3 py-2 text-sm font-medium button2 text-light"
              >
                Sign Up
              </Link>
            </div>
